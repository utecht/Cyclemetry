...
function design(template) {
  ...
  if (typeof template.design === "string") {
    return { label: "Design", url: template.design };
  }
  return template.design.url ? template.design : null;
}
    ...
    <div className="showcase-page showcase-page-wide">
            ...
            <div key={template.name} className="showcase-card">
              <div className="showcase-card-video">
                <a
                  ...
                  aria-label={`View ${template.displayName} template`}
                >
                  <img
              ...
              <div className="showcase-card-info">
                ...
                <div className="showcase-card-actions">
                  <a
                    className="showcase-button showcase-button-sm"
      ...
      <div className="showcase-submit-panel">
        <div>
          ...
          <p>
            Created a customized telemetry overlay you love? Share it with the
            community.
          </p>
        </div>
        <div className="showcase-submit-actions">
          <a
            ...
            href="https://github.com/walkersutton/cyclemetry/tree/main/templates"
            target="_blank"
            rel="noopener noreferrer"
          >
